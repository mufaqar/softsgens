...
export const Brands = () => {
  ...
  return (
    <div>
      <h2 className="mt-2 text-center text-gray-700 main-title">Brands</h2>
      ...
      <div ref={ref} className="flex justify-around gap-4 lg:px-8 _brand">
        <motion.figure
          ...
          className="w-52 h-52 grayscale hover:grayscale-0"
        >
          <Image src={brand1} alt="Brands Picture"></Image>
        </motion.figure>
        <motion.figure
          animate={animationOpacity}
          className="w-52 h-52 grayscale hover:grayscale-0"
        >
          <Image src={brand2} alt="Brands Picture"></Image>
        </motion.figure>
        <motion.figure
          animate={animationOpacity}
          className="w-52 h-52 grayscale hover:grayscale-0"
        >
          <Image src={brand3} alt="Brands Picture"></Image>
        </motion.figure>
        <motion.figure
          animate={animationOpacity}
          className="w-52 h-52 grayscale hover:grayscale-0"
        >
          <Image src={brand5} alt="Brands Picture"></Image>
        </motion.figure>
        <motion.figure
          animate={animationOpacity}
          className="w-52 h-52 grayscale hover:grayscale-0"
        >
          <Image src={brand6} alt="Brands Picture"></Image>
        </motion.figure>
      </div>
    </div>
  );
