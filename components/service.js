...
export default function Service() {
  ...
  return (
    <div className='container mx-auto mt-32' ref={ref}>
        <motion.h1 className='text-center main-title text-secoundry' animate={animation}>Services</motion.h1>
        ...
        <div className='grid mt-16 md:grid-cols-2' >
            <motion.div className='flex justify-center ser-img' animate={animationImg}>
                <Image src={ServicesImg} alt="img"></Image>
            </motion.div>
            <div className='grid grid-cols-2'>
                <motion.div animate={animationicon} className='flex flex-col items-center justify-center mt-8'>
