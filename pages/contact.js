  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Get in touch with SoftGens. Contact us for web development, WordPress, React, Next.js, UGC ads, and digital marketing services." />
      </Head>
      ...
      <div className="container mx-auto mt-48 mb-28 ">
        ...
        >
          ...
          >
            <div>
              ...
              <p className="pt-2 text-sm text-gray-400">
                For all your non-existant company needs Fake Corp are <br />
                here to help, do not hesitate to contact us!
              </p>
            </div>
            <div className="flex flex-col space-y-6">
              ...
              <div className="inline-flex items-center space-x-2">
                ...
                <span>Suit 134-B Multan Road Lahore, Pakistan</span>
              </div>
            </div>
            <div className="flex space-x-4">
              <a href="https://facebook.com/softsgens" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
              ...
              <a href="https://instagram.com/softsgens" target="_blank" rel="noreferrer">
                <svg
                   xmlns="http://www.w3.org/2000/svg"
                   width="18"
                   height="18"
              ...
              <a href="https://twitter.com/softsgens" target="_blank" rel="noreferrer">
                <svg
                   xmlns="http://www.w3.org/2000/svg"
                   width="18"
                   height="18"
              ...
              <a href="https://linkedin.com/company/softs-generations" target="_blank" rel="noreferrer">
                <svg
                   xmlns="http://www.w3.org/2000/svg"
                   width="18"
                   height="18"
          ...
          <div className="relative px-4 ">
            ...
            ></motion.div>
            <motion.div
              className="relative z-10 p-8 text-gray-600 bg-white shadow-lg rounded-xl md:w-[560px]"
              animate={animation}
            >
              <form className="flex flex-col space-y-4" action="#" onSubmit={(e) => e.preventDefault()}>
                <div>
