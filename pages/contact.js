...
export default function ContactMe() {
  return (
    <>
      ...
      <div class="container mx-auto mt-48 mb-28">
        <div class="flex flex-col md:flex-row justify-between text-black ">
          <div class="flex flex-col space-y-8 justify-between">
            <div>
              ...
              <p class="pt-2 text-gray-400 text-sm">For all your non-existant company needs Fake Corp are <br/>here to help, do not hesitate to contact us!</p>
            </div>
