    ...
    <>
      ...
      <section className="py-12 mt-20 px-8">
        <div className="md:max-w-[1140px] mx-auto flex md:flex-row flex-col ">
          ...
          <div className="md:w-1/2 w-full relative h-screen">
            <Image src={project?.mobile_view_image?.asset.url} alt="" className="rounded-3xl" layout="fill" objectFit="cover" />
          </div>
        </div>
      </section>

      <section className="py-12 px-8 relative w-[95%] h-screen mx-auto rounded-3xl">
        <Image src="/images/services.png" alt=""  layout="fill" className="rounded-3xl" objectFit="cover" />
      </section>
      ...
      <section className="py-24 px-8">
        <div className="md:max-w-[1140px] mx-auto longinfo">
          ...
          <PortableText
            ...
            serializers={{
              h1: props => <h1 className="md:text-5xl text-4xl leading-7 font-bold tracking-wide mb-5" {...props} />,
              h2: props => <h1 className="md:text-5xl text-4xl leading-7 font-bold tracking-wide mb-5" {...props} />,
              p: props => <p className="text-xl text-slate-500 mb-5" {...props} />,
              li: ({ children }) => <li className="text-xl text-slate-700 font-bold">{children}</li>
            }}
          />
      ...
      <section className="py-12 px-8 relative w-[95%] mx-auto ">
      {
        project?.gallery.map((gal,idx)=>(
          <img src={gal?.asset.url} alt="" className="w-full mb-10 rounded-3xl" key={idx}/>
        ))
      }
